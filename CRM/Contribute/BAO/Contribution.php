...
";
  ...
  public static function recordFinancialAccounts(&$params, $financialTrxnValues = NULL) {
    ...
    if ($contributionStatus == 'Partially paid'
      ...
      if (empty($balanceTrxnInfo['trxn_id'])) {
        ...
        $balanceTrxnParams['credit_card_type'] = CRM_Utils_Array::value('credit_card_type', $params);
        $balanceTrxnParams['credit_card_number'] = CRM_Utils_Array::value('credit_card_number', $params);
  ...
  public static function updateFinancialAccounts(&$params, $context = NULL, $skipTrxn = NULL) {
    ...
    CRM_Core_BAO_FinancialTrxn::createDeferredTrxn(CRM_Utils_Array::value('line_item', $params), $params['id'], TRUE, $context);
  }
  ...
  public static function recordAdditionalPayment($contributionId, $trxnsData, $paymentType = 'owed', $participantId = NULL, $updateStatus = TRUE) {
    ...
    $params['credit_card_type'] = CRM_Utils_Array::value('credit_card_type', $trxnsData);
    $params['credit_card_number'] = CRM_Utils_Array::value('credit_card_number', $trxnsData);
    ...
    if ($getTrxnInfo && $baseTrxnId) {
      ...
      $sql = "
        SELECT GROUP_CONCAT(fa.`name`) as financial_account,
          ...
          ft.trxn_date, ft.trxn_id, ft.status_id, ft.check_number, con.currency, ft.credit_card_number, ft.credit_card_type
